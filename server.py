...
def signup(): 
    ...
    if form.is_submitted():
        ...
        return render_template('report.html',
                                ...
                                description=get_description(get_type(personality)),
                                # send graphical represenation of personality

                                # send Pokemon API attributes
                                pokemon=pb.pokemon(str(get_description(get_type(personality))[0].lower())),
                                # send sprite of corresponding Pokemon
                                sprite=pb.SpriteResource('pokemon', pb.pokemon(str(get_description(get_type(personality))[0].lower())).id).url)
    # remain on page
